    ...
    <nav class="border-b">
            <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button type="button" class="px-3 py-1 rounded-md bg-transparent text-[#1b1b18] hover:underline">Sign in</button>
                    </a>
                    <a href="/auth/register">
                    <button type="button" class="px-3 py-1 rounded-md bg-[#1b1b18] text-white">Sign up</button>
                    </a>
                </div>
            </div>
    </nav>
